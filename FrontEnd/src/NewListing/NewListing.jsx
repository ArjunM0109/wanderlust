...
export default function NewListing() {
  ...
  const [listing, setListing] = useState({
    title: "",
    description: "",
    image: "", // Just store the file object directly
    price: 0,
    location: "",
    country: ""
  });
        ...
        <div className="col-12 col-md-10 p-4 bg-gradient rounded z-1">
          <form onSubmit={handleSubmit} encType="multipart/form-data">
            ...
            <div className="mb-3">
              ...
              <input type="text" className="form-control" id="image" name="image"  value={listing.image} onChange={handleChange} required />
            </div>
